...
class BottleneckBlock(nn.Module):
    ...
    def __init__(self, c1, c2, shortcut=True, e=0.5):
        """Initializes a standard bottleneck layer with optional shortcut supporting channel expansion."""
        super().__init__()
...
class C3(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, e=0.5):
        ...
        self.cv3 = ConvBlock(2 * c_, c2, 1, 1)  # optional act=FReLU(c2)
...
class CustomYOLOv5(nn.Module):
    def __init__(self, num_classes=10, num_anchors=1, anchors=[[8, 8]]):
        super().__init__()
        # input = 384 x 640 x 3
        ...
        self.neck = nn.Sequential(
            C3(256, 256, 1),
            ConvBlock(256, self.na * (self.nc + 5), 1, 1, 0)  # 24 x 40 x 15
        )
